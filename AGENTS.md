...
- **Protected admin:** `/admin/*` (11 sub-pages: users, societies, services, reviews, broadcast, tickets, audit, settings, wallet, bookings, subscriptions)
...
- `coinService.ts` — Wallet ledger with dual-bucket tracking (cashable NC vs promo NC), coin packs, referrals, payouts (19 ledger types including `subscription_debit`)
...
- `coinLedger/{uid}/entries` — Coin transaction history (19 types: topup, booking_*, payout*, earn_*, admin_*, subscription_debit)
