...
const STATIC_FAQS: FAQ[] = [
  ...
  { question: "How do Referral Codes work?", answer: "Share your referral code from your Wallet page. If a new user signs up with your code or referral link, they receive an instant referral NC credit.", category: "account", order: 9, active: true },
