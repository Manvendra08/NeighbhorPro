...
export default function TermsOfService() {
  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "40px 24px" }}>
      ...
      {[
        ["1. Acceptance", "By creating a ProNeighbour account or using the platform, you agree to these Terms. If you do not agree, please do not use the service."],
        ["2. Platform Description", "ProNeighbour is a hyperlocal professional services marketplace connecting residents of gated communities with verified professionals. We are a technology platform, not a service provider. All services are rendered by independent professionals who are residents of the relevant society."],
        ["3. Eligibility", "You must be 18 years or older and a verified resident or professional in a registered society to use ProNeighbour. We reserve the right to verify residency and suspend accounts where verification fails."],
        ...
        ["6. Professional Conduct", "Professionals listed on ProNeighbour are independent service providers. ProNeighbour does not employ them and is not liable for the quality, outcome, or legality of their services. Users are responsible for assessing suitability before booking."],
        ...
        ["9. Limitation of Liability", "ProNeighbour is not liable for any indirect, incidental, or consequential damages arising from use of the platform, including disputes between residents and professionals."],
