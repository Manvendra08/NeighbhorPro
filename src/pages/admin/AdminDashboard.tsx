...
import { getAllUsers, getAllBookings, getTransactions, getAllSocieties } from "../../services/firestoreService";

export default function AdminDashboard() {
  const [stats, setStats] = useState({ users: 0, bookings: 0, revenue: 0, commission: 0, societies: 0 });
