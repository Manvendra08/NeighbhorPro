    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
        ...
        {localStatus === "in_progress" && (
          <span style={{ fontSize: 13, color: "var(--muted)" }}>Support is working on this ticket. You can continue sharing updates.</span>
        )}
        {(localStatus === "resolved" || localStatus === "closed") && (
          <span style={{ fontSize: 13, color: "var(--muted)" }}>This ticket is closed for replies. Reopen it if you need further help.</span>
        )}
      </div>
    </div>
  );
