...
export const ALLOWED_TYPES: Record<string, string[]> = {
  ...
  residencyProof:["image/jpeg", "image/png", "image/webp", "application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"],
