...
- Name: signup-flow.spec.ts >> Signup Flow >> should show error for password mismatch
- Location: e2e\signup-flow.spec.ts:55:3
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e23]:
      ...
      - generic [ref=e27]:
        ...
        - textbox "you@example.com" [ref=e29]: testuser_1777973495101@proneighbor.test
      - generic [ref=e30]:
        - generic [ref=e31]: Password
        - textbox "Min 8 characters" [ref=e32]: TestPassword123!
      - generic [ref=e33]:
        - generic [ref=e34]: Confirm Password
        - textbox "••••••••" [active] [ref=e35]: DifferentPassword123!
      - generic [ref=e36]:
