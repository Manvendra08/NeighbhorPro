...
- Name: signup-flow.spec.ts >> Signup Flow >> should show error for already registered email
- Location: e2e\signup-flow.spec.ts:99:3
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e23]:
      ...
      - generic [ref=e27]:
        ...
        - textbox "you@example.com" [ref=e29]: test@proneighbor.test
      - generic [ref=e30]:
