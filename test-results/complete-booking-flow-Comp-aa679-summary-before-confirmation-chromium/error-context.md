...
- Name: complete-booking-flow.spec.ts >> Complete Booking Flow >> should show booking summary before confirmation
- Location: e2e\complete-booking-flow.spec.ts:195:3
