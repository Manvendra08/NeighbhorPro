...
- Name: login-flow.spec.ts >> Login Flow >> should display login page correctly
- Location: e2e\login-flow.spec.ts:17:3
...
Expected: visible
Error: strict mode violation: locator('img[alt*="Logo"]') resolved to 2 elements:
    1) <img alt="Logo" loading="lazy" src="/images/logo_new.png"/> aka getByRole('link', { name: 'Logo ProNeighbor' })
    2) <img alt="Logo" loading="lazy" src="/images/logo.png"/> aka getByRole('link', { name: 'Logo', exact: true })
