...
- Name: complete-booking-flow.spec.ts >> Complete Booking Flow >> should display available time slots for selected date
- Location: e2e\complete-booking-flow.spec.ts:158:3
