...
- Name: login-flow.spec.ts >> Login Flow >> should show error for invalid credentials
- Location: e2e\login-flow.spec.ts:39:3
...
Locator: locator('text=/incorrect|invalid|wrong|not found/i')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/incorrect|invalid|wrong|not found/i')
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e24]:
      - generic [ref=e25]:
        ...
        - textbox "you@example.com" [ref=e27]: invalid@example.com
      - generic [ref=e28]:
