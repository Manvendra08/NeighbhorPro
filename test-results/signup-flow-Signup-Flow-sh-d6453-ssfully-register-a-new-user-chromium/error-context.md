...
- Name: signup-flow.spec.ts >> Signup Flow >> should successfully register a new user
- Location: e2e\signup-flow.spec.ts:70:3
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e23]:
      ...
      - generic [ref=e27]:
        ...
        - textbox "you@example.com" [ref=e29]: testuser_1777973560089@proneighbor.test
      - generic [ref=e30]:
        - generic [ref=e31]: Password
        - textbox "Min 8 characters" [ref=e32]: TestPassword123!
      - generic [ref=e33]:
        - generic [ref=e34]: Confirm Password
        - textbox "••••••••" [ref=e35]: TestPassword123!
      - generic [ref=e36]:
        - generic [ref=e37]: Referral Code (optional)
        - textbox "PNXXXXXX" [ref=e38]
      - generic [ref=e39]:
        - checkbox "I have read and agree to the Terms of Service and Privacy Policy." [checked] [active] [ref=e40]
